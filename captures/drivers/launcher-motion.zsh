#!/bin/zsh
# Launcher tab recording (~15s): hover Cooking -> Reading -> Workout, then
...
drive() {
  sleep 2
  # Cooking -> Reading -> Workout, entering each card at its own height
  rmove 260 134; sleep 0.2; rmove 389 134; sleep 2.2          # Cooking
